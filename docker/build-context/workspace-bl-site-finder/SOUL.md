...
4. **`search.py` is the primary discovery path.** Path: `/home/openclaw/.openclaw-backlink/workspace-bl-orchestrator/skills/search/search.py`.
...
| Purpose | Tool | Notes |
|---|---|---|
| Find candidate sites | `python3 /home/openclaw/.openclaw-backlink/workspace-bl-orchestrator/skills/search/search.py --query "..."` | Primary tool |
